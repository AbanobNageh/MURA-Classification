...
class Densenet:
    data_dir = "densenet-data/"                                                # Directory of the densenet data.
    path_graph_def = "densenet161_k48_frozen.pb"                               # The pb file name
    tensor_name_input_image = "input:0"                                        # Name of the input tensor
    tensor_name_transfer_layer = "densenet161/final_block/global_avg_pool:0"   # Name of the output tensor
