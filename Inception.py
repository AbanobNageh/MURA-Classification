...
class Inception:
    data_dir = "inception-data/"                     # Directory of the inception data.
    path_graph_def = "classify_image_graph_def.pb"   # The pb file name
    tensor_name_input_image = "DecodeJpeg:0"         # Name of the input tensor
    tensor_name_transfer_layer = "pool_3:0"          # Name of the output tensor
